<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Post Categories Create') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Create Post Category') }}</flux:subheading>
    ...
    <div class="flex justify-end mb-4">
      <a href="{{ route('categorys.index') }}" id="backBtn" class="bg-green-600 text-white text-sm px-3 py-1 rounded hover:bg-green-700 flex items-center" wire:navigate>
