<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Slider Create') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Create Slider') }}</flux:subheading>
    ...
    <div class="flex justify-end mb-4">
      <a href="{{ route('slider.index') }}" id="backBtn" class="bg-green-600 text-white text-sm px-3 py-1 rounded hover:bg-green-700 flex items-center" wire:navigate>
    ...
    <div class="w-full">
      <form wire:submit="submit" class="space-y-6">
        <div class="flex flex-wrap gap-4">
          ...
          <div class="flex-1 min-w-[200px]">
            <flux:input wire:model="image" label="Image" type="file" placeholder="Image" />
          </div>
        </div>
        <div class="flex flex-wrap gap-4">
          <div class="flex-1 min-w-[200px]">
