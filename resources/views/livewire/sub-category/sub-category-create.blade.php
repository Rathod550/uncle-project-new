<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Post Sub Categories Create') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Create Post Sub Category') }}</flux:subheading>
            ...
            <form wire:submit="submit" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="flex flex-col md:flex-row gap-4 w-full">
                    ...
                    <div class="flex-1 min-w-[200px]">
                        <flux:input wire:model="name" label="Name" placeholder="Name" class="w-full" />
                    </div>
